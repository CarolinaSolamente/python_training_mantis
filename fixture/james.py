...
class JamesHelper:
     ...
     def ensure_user_exists(self, username, password): # here login/password for user, we create it
     ...
     class Session:
         ...
         def __init__(self, host, port, username, password): # here login/password for post server
         ...
         def is_users_registered(self, username):
             ...
             return res[0] == 0 # if 0 - user is, 1 - user is not
